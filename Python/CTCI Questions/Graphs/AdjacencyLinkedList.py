...
### Framework for a Singly Linked List: 
...
class LLNode: 
    ...
    def __init__(self, data, weight = 0): 
        ...
        # 1. Data value: The data value can be of any type: Thats good!!!
        self.data = data
...
#         # Parameters of the Linked list are the head node: 
#         self.head = LLNode(data)
    ...
    def insert_head(self,new, weight =0): 
